    ...
    <React.Fragment>
      ...
      <div className='flex flex-wrap'>
        ...
        <div className='w-full lg:w-1/2'>
          <div className='bg-orange-500 py-24 lg:py-72 xl:py-96'>
            <div className='flex flex-col justify-center items-center h-full'>
              ...
              >
                <path
                  d='M300.001 75V12.5C300.001 5.59644 294.404 1.94094e-06 287.501 1.63918e-06L250.001 0C243.097 -3.01765e-07 237.501 5.59644 237.501 12.5V62.5C237.501 103.921 203.922 137.5 162.501 137.5L112.501 137.5C105.597 137.5 100.001 143.096 100.001 150V187.5C100.001 194.404 105.597 200 112.501 200L175.001 200C244.036 200 300.001 144.036 300.001 75Z'
                  fill='#FFF2D6'
                />
                <path
                  d='M7.45305e-07 125L0 187.5C-8.23241e-08 194.404 5.59644 200 12.5 200H50C56.9036 200 62.5 194.404 62.5 187.5V137.5C62.5 96.0786 96.0786 62.5 137.5 62.5H187.5C194.404 62.5 200 56.9036 200 50V12.5C200 5.59645 194.404 4.5038e-06 187.5 4.42148e-06L125 3.67618e-06C55.9644 2.85294e-06 1.56855e-06 55.9644 7.45305e-07 125Z'
                  fill='#FFF2D6'
                />
              </svg>
            </div>
